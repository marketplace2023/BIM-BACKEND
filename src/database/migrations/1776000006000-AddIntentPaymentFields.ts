...
export class AddIntentPaymentFields1776000006000 implements MigrationInterface {
  name = 'AddIntentPaymentFields1776000006000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`commerce_intent\`
        ADD CONSTRAINT \`FK_commerce_intent_payment_method\`
